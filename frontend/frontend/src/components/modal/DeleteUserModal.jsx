...
const DeleteUserModal = ({ isOpen, onClose, userId, setMessageFromChild}) => {
    const handleDelete = (e) => {
        e.preventDefault();
        const token = localStorage.getItem("token")
        const url = "http://127.0.0.1:8081/user/delete/" + e.currentTarget.id;
                ...
                <div className="relative bg-white rounded-2xl shadow-lg">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="p-6 pt-0 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Bạn có chắc muốn xoá người dùng này?</h3>
                            <button
                                id={userId}
