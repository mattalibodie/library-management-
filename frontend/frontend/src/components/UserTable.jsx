                ...
                {userLists.length > 0 &&
                  userLists.map((user) => (
                    <tr key={user.id} className="hover:bg-gray-100">
                      ...
                      <td className="hidden p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5">
                        {user.id}
                      </td>
                      ...
                      <td className="p-4 space-x-2 whitespace-nowrap lg:p-5 flex justify-end">
                        ...
                        <button
                          onClick={() => setDeleteUserModalOpen(user)}
                          type="button"
...
UserTable.propTypes = {
  ...
  setDeleteUserModalOpen: PropTypes.func.isRequired,
};
